...
public class NameDecoderTest {
  ...
  static Stream<Arguments> argumentsProvider() {
    return Stream.of(
      ...
      Arguments.of(Mode.MOVIE, "Underworld  - 03 - Rise of the Lycans [2009, Action Fantasy Horror Thriller, 1080p].mkv", "Underworld", null, "Rise of the Lycans", "03", 2009, null, "mkv"),
      ...
      Arguments.of(Mode.MOVIE, "Die Hard - 04 - Live Free or Die Hard [2007, Action Crime Thriller, 1080p].mkv", "Die Hard", null, "Live Free or Die Hard", "04", 2007, null, "mkv"),
      ...
      //Arguments.of("James Bond - 04b - Never say never again [1983, 720p].mkv", "James Bond", null, "Never say never again", "04b", 1983, null, "mkv"),
      Arguments.of(Mode.MOVIE, "James Bond - 20 - Die Another Day [2002 (246460), Action Adventure Thriller, 720p].tar.gz", "James Bond", null, "Die Another Day", "20", 2002, "246460", "tar.gz"),
      Arguments.of(Mode.MOVIE, "Hauru no Ugoku Shiro (Howl's Moving Castle) [2004, Animation Adventure Fantasy Romance].mkv", "Hauru no Ugoku Shiro", "Howl's Moving Castle", null, null, 2004, null, "mkv"),
      ...
      Arguments.of(Mode.EPISODE, "Dharma.And.Greg.-.2x18.-.See.Dharma.Run.Amok.english-japanese.[tvu.org.ru].mpg", "Dharma And Greg", null, "See Dharma Run Amok english-japanese [tvu org ru]", "2,18", null, null, "mpg"),
      Arguments.of(Mode.EPISODE, "Battlestar_Galactica_2003_-_1x01_-_Lowdown_(documentary).avi", "Battlestar Galactica 2003", null, "Lowdown (documentary)", "1,01", null, null, "avi"),
      ...
      Arguments.of(Mode.EPISODE, "Monk.S01E01-02.Mr.Monk.and.the.Candidate.720p.WEB-DL.H264.AAC20-myTV.mkv", "Monk", null, "Mr Monk and the Candidate 720p WEB-DL H264 AAC20-myTV", "01,01-02", null, null, "mkv"),
      ...
      Arguments.of(Mode.EPISODE, "Police_Squad!_-_1x05_-_Rendezvous_At_Big_Gulch_(Terror_In_The_Neighborhood).avi", "Police Squad!", null, "Rendezvous At Big Gulch (Terror In The Neighborhood)", "1,05", null, null, "avi"),
      ...
      Arguments.of(Mode.EPISODE, "terminator.the.sarah.connor.chronicles.215.desert.cantos-sitv.mkv", "terminator the sarah connor chronicles", null, "desert cantos-sitv", "2,15", null, null, "mkv"),

      Arguments.of(Mode.EPISODE, "Stargate.Universe.S01E01-E03.Air.Extended.720p.Bluray.DTS.x264-DiRTY.mkv", "Stargate Universe", null, "Air Extended 720p Bluray DTS x264-DiRTY", "01,01-03", null, null, "mkv"),
      ...
      Arguments.of(Mode.EPISODE, "Battlestar Galactica 1978 - 1x01-03 Saga Of A Star World 2.avi", "Battlestar Galactica 1978", null, "Saga Of A Star World 2", "1,01-03", null, null, "avi"),
      ...
      // Special numbers:
      Arguments.of(Mode.SPECIAL, "Heroes.S04.Bonus.Genetics.of.a.Scene.720p.BluRay.x264-EbP.mkv", "Heroes", null, "Bonus Genetics of a Scene 720p BluRay x264-EbP", "04", null, null, "mkv"),
