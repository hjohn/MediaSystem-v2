...
public class NameDecoderTest {
  ...
  static Stream<Arguments> argumentsProvider() {
    return Stream.of(
      ...
      Arguments.of(Mode.MOVIE,   "Die Hard 4 (Live Free or Die Hard) [2007, Action, 1080p].mkv",      "Die Hard 4",           "Live Free or Die Hard", null,                    null, 2007, null,      "mkv"),
      ...
      Arguments.of(Mode.EPISODE, "Dharma.And.Greg.-.2x18.-.See.Dharma.Run.Amok.[tvu.org.ru].mpg",     "Dharma And Greg",      null, "See Dharma Run Amok [tvu org ru]", "2,18",     null, null, "mpg"),  // TODO perhaps strip out square bracketed stuff
      ...
      Arguments.of(Mode.EPISODE, "Pillars.of.the.Earth.Part.1.720p.BluRay.X264-REWARD.mkv",           "Pillars of the Earth", null, "720p BluRay X264-REWARD",          ",1",       null, null, "mkv"),  // An episode
      Arguments.of(Mode.EPISODE, "Billy Blackburn's Treasure Chest Part 1.mkv",           "Billy Blackburn's Treasure Chest", null, null,                               ",1",       null, null, "mkv"),  // A special (can't distinguish with above)
