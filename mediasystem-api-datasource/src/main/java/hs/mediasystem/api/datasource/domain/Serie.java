...
public class Serie extends Production {
   ...
   */
  public Serie(WorkId id, Details details, Reception reception, String tagLine, Classification classification, State state, LocalDate lastAirDate, double popularity, List<Season> seasons) {
    super(id, details, reception, null, tagLine, classification, popularity);
