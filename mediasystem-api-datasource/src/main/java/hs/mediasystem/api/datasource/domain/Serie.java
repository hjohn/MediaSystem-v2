...
public class Serie extends Production {
   ...
   */
  public Serie(WorkId id, Details details, Reception reception, String tagLine, Classification classification, State state, LocalDate lastAirDate, double popularity, List<Season> seasons, Set<WorkId> relatedWorks) {
    super(id, details, reception, null, tagLine, classification, popularity, relatedWorks);
