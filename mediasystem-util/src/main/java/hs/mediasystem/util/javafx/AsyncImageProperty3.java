...
public class AsyncImageProperty3 extends SimpleObjectProperty<Image> {
  private static final ThreadPoolExecutor EXECUTOR = new ThreadPoolExecutor(2, 2, 5, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(), new NamedThreadFactory("AsyncImageProperty", Thread.NORM_PRIORITY - 2, true));
