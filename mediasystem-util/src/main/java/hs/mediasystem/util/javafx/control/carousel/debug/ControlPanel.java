package hs.mediasystem.util.javafx.control.carousel.debug;

import hs.mediasystem.util.javafx.control.carousel.Layout;
import hs.mediasystem.util.javafx.control.carousel.RayLayout;
...
public class ControlPanel extends VBox {
  ...
  public ControlPanel(Layout layout) {
    this.layout = layout;
