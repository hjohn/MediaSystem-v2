...
public class GenericCollectionPresentation<T extends MediaDescriptor> extends GridViewPresentation<T> {
  ...
  protected GenericCollectionPresentation(SettingsSource settingsSource, MediaService mediaService, ObservableList<MediaItem<T>> items, ViewOptions<T> viewOptions, MediaItem<?> contextItem) {
