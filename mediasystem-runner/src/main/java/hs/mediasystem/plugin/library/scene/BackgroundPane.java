...
public class BackgroundPane extends StackPane {
  ...
  private static final long LOAD_MILLIS = 15000;    // How long to wait for a new image to be loaded before displaying an empty image
  private static final Duration MAX_LOAD_DURATION = Duration.millis(LOAD_MILLIS);
  private static final Image EMPTY_IMAGE = new Image(BackgroundPane.class.getResourceAsStream("curtain.jpg"));
