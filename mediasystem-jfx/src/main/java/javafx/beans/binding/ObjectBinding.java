...
public abstract class ObjectBinding<T> extends ObjectExpression<T> implements
    ...
    private boolean isObserved;  // JOHN/JH: Fix extra invalidation, see JDK-8303897
    ...
    public void addListener(InvalidationListener listener) {
        isObserved = isObserved || listener != null;  // JOHN/JH: Fix extra invalidation, see JDK-8303897
    ...
    public void removeListener(InvalidationListener listener) {
        ...
        isObserved = helper != null;  // JOHN/JH: Fix extra invalidation, see JDK-8303897
    }
    ...
    protected final boolean isObserved() {
        return isObserved;  // JOHN/JH: Fix extra invalidation, see JDK-8303897
    }
